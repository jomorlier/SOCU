...
problems<-c("G06-14n-WK")  #G06-15d-WK122 "sphere4-13-WK" "G06-2-WK"

#problems<-c("G06-14b-WK")  #"sphere4-13-WK" "G06-2-WK"
#problems<-c("G06-15-WK")  #G06-15d-WK122 "sphere4-13-WK" "G06-2-WK"
...
for(problem in problems){
  ...
  if (lbig>1) cat(sprintf("%s:   mean final error = %9.2e, median = %9.2e\n",
                          mySORC$name,mean(err),median(err)))
